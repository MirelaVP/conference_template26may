...
function Logistics() {
    ...
    return (
        <div>
            ...
            <p> <a href= "http://www.grandhotelvictorhugo.lu/en/">Hotel Victor Hugo</a> is frequently used by visitors of the university and is 15 minutes on foot from the conference site.
            Address: 2 Av. Victor Hugo, 1750 Limpertsberg Luxembourg
            </p>
            </p> <a href= "https://hdg.lu">Hosteliere du Grünewald</a> is located in Luxembourg-Dommeldange, and about 30 minutes by public transport to the conference site. For university vistors a promotional code "Uni2023" is applicable for 10% discount.
